...
class Painter(WidgetElement):
    ...
    def draw_paint_order_polygon(self,
            paint_order):
        po = paint_order
        self.set_brush_with(po["width"])
        self.set_brush_with(po["color_key"])
    ...
    las borre.
    """
    def add_in_buffer(self, photo_image):
        self.__photo_image_array \
            .append(photo_image)
    ...
    def set_brush_point(self, point_ar):
        self.__brush_point = point_ar

    def set_brush_color(self, key_color):
        self.__brush_color = key_color

    def set_brush_with(self, integer):
        self.__brush_with = integer
